...
#' @param p Accepts a list of probabilities as c(1-p,p)
...
#' @export
shiftConvolveLog<-function(p, S0){
...
#' @param S0 An observed value
#' @param far.tail Logical determining whether to sum the far tail (default) or near tail
#'
